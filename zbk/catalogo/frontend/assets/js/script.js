...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const { documento, nombre, apellidos, email, editar, image } = form.elements;
  ...
  form.addEventListener("submit", function (event) {
    ...
    api({
      ...
      .then(({ data }) => {
        ...
        cargarDatosCliente(); // Llamar función para actualizar la tabla con los datos del cliente nuevo
        form.reset();
        modal.hide();
      })
      .catch((err) =>
